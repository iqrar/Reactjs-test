        ...
        render: function() {
           return (
            ...
            <article className="frontpage-article">
                    ...
                    <h1 className = "h1-size-change">Lorem ipsum dolor</h1> 
                    ...
                    <h2  className = "h2-size-change">Morbi at tincidunt diam.</h2>
                    ...
                    <h2 className = "h2-size-change">Fusce lobortis</h2> 
                    ...
                    <h2 className = "h2-size-change">In viverra augue id elit tempor euismod.</h2>
